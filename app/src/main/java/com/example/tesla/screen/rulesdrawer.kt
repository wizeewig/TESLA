...
@Composable
fun rulesdrawer(navController: NavController){
    Scaffold(
        topBar = {
            TopAppBar(
                title = {Text(
        ...
        content = { ScaffoldWithTopBarRulesDrawer(navController as NavHostController)}
    )
}
...
@SuppressLint("UnusedMaterialScaffoldPaddingParameter")
@Composable
fun ScaffoldWithTopBarRulesDrawer(navController: NavHostController) {
